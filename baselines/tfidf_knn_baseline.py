...
def load_labels(split):
    with open(os.path.join(args.data_dir, '{}.csv'.format(split)), 'r', encoding='utf-8') as fp:
...
if __name__ == '__main__':
    ...
    knn_classifier = KNeighborsClassifier(n_neighbors=25, n_jobs=4)
    ...
    with open('../baselines_predictions/tfidf_knn_baseline.csv', 'w', encoding='utf-8') as fp:
